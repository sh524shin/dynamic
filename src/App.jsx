        ...
        <AnimatePresence mode="wait">
          {activeTab === 'home' && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              className="py-6 md:py-12 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12"
            >
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-text-muted text-base md:text-lg mb-8 md:mb-12 max-w-2xl mx-auto md:mx-0">
                ...
                <div className="flex justify-center md:justify-start gap-4 md:gap-6">
                  <button
                    ...
                    className="relative group px-8 md:px-10 py-4 md:py-5 overflow-hidden rounded-2xl bg-primary font-black text-base md:text-lg transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(99,102,241,0.5)]"
                  >
                  ...
                  <button
                    ...
                    className="glass px-8 md:px-10 py-4 md:py-5 text-base md:text-lg font-black text-white hover:bg-white/10 transition-all border border-white/20 hover:border-white/40"
                  >
                    공식 도감 보기
                  </button>
                </div>
